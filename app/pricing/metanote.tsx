...
const Home = () => {
  ...
  const getHrefBasedOnOS = () => {
    if (os === "Windows") {
      return "https://github.com/shafisma/noteBro/releases/download/Release/mysetup.exe";
    } else if (os === "Android") {
      return "https://github.com/shafisma/noteBro/releases/download/Release/app-release.apk";
    } else {
  ...
  const getsvgBasedOnOS = () => {
    if (os === "Windows") {
      return (
        <svg width="20" height="19" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48"><path fill="#1976d2" d="M6,6h17v17H6V6z"/><path fill="#1976d2" d="M25.042,22.958V6H42v16.958H25.042z"/><path fill="#1976d2" d="M6,25h17v17H6V25z"/><path fill="#1976d2" d="M25,42V25h17v17H25z"/></svg>
      );
    } else if (os === "Android") {
      return (
    ...
    <>
        ...
        {os && (
          <div>
            ...
            >
            <button className='bg-gray-500 text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-gray-950 dark:focus-visible:ring-gray-300'>
            {getsvgBasedOnOS()}
                Downoad for {os}
                </button>
          </a>

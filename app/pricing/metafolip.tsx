...
const Home = () => {
  ...
  const getHrefBasedOnOS = () => {
    if (os === "Windows") {
      return "https://github.com/shafisma/folip/releases/download/release/Shafi.exe";
    } else if (os === "Android") {
      return "https://github.com/shafisma/folip/releases/download/release/app-release.apk";
    } else {
